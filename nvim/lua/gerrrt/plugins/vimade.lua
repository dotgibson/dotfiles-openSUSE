...
--         which leaves no cue for WHICH split is live. dropbar's winbar (plugins/dropbar-nvim.lua)
--         names the file in each window; vimade completes the picture by fading the INACTIVE windows
--         so the focused split pops. Paired with the active-only cursorline autocmd (config/autocmds.lua).
